...
//alert('hi');
//let ingresar = parseInt(prompt(`Password`));


//if( ingresar == 'sari2022'){
    //console.log('joined');
//}
//while (ingresar != 'sari2022'){
    //ingresar = prompt(`Password`);
//}

//confettis en la foto
...
//let confettiFoto = document.getElementById(`confettiFoto`);

let confetti = new Confetti('confettiFoto');
...
const jsConfetti = new JSConfetti();
    ...
    let botonConfetti = document.getElementById("btnConfetti")
    botonConfetti.addEventListener("click", confettiBtn);
...
var confettiIndex = new ConfettiGenerator(confettiSettings);
confettiIndex.render();
